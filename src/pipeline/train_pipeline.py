...
def train_and_evaluate_model(
    ...
    final_full_cfg.environment.lookback_window = best_params.get('lookback_window') if best_params else cfg.environment.lookback_window
    ...
    if latest_checkpoint:
        ...
        if best_params is not None:
            ...
            if agent_type == 'sac':
                final_model = create_sac_model(None, final_env, final_full_cfg)
            else:
